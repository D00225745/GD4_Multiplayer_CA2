...
void World::AddEnemies()
{
	...
	AddEnemy(AircraftType::kAvenger, 850.f, 2200.f);
	AddEnemy(AircraftType::kRaptor, 550.f, 2200.f);
	...
	AddEnemy(AircraftType::kRaptor, -350.f, 3250.f);
	...
	AddEnemy(AircraftType::kRaptor, 250.f, 4700.f);
	AddEnemy(AircraftType::kRaptor, 550.f, 4700.f);
	AddEnemy(AircraftType::kRaptor, 950.f, 4700.f);
	AddEnemy(AircraftType::kRaptor, -250.f, 4700.f);
	AddEnemy(AircraftType::kRaptor, -550.f, 4700.f);
	AddEnemy(AircraftType::kRaptor, -950.f, 4700.f);
	AddEnemy(AircraftType::kBoss, 0.f, 5500.f);
	AddEnemy(AircraftType::kBoss, -950.f, 5500.f);
	AddEnemy(AircraftType::kBoss, -450.f, 5500.f);
	AddEnemy(AircraftType::kBoss, -250.f, 5500.f);
	AddEnemy(AircraftType::kBoss, 900.f, 5500.f);
	AddEnemy(AircraftType::kBoss, 450.f, 5500.f);
	AddEnemy(AircraftType::kBoss, 200.f, 5500.f);
